...
\definecolor{toolingblue}{RGB}{100, 149, 237}
...
\newcommand{\toolmark}{\textcolor{toolingblue}{$\bullet$}}
...
\begin{itemize}
  \item \toolmark\ Established the traccc (GPU track reconstruction) environment
\end{itemize}
};
...
\begin{itemize}
  ...
  \item \collabmark\ Analyzed next steps and reported to the European team
...
\begin{itemize}
  \item \toolmark\ Set up the Nvidia Nsight Systems (profiler) environment
...
\begin{itemize}
  ...
  \item \collabmark\ Reported results to the European team
  \item \confmark\ Assisted YunChen with the \conf{TJCAS} (conference) submission
  \item \toolmark\ Attempted Nsight Compute (kernel profiler) setup (severe environmental issues)
\end{itemize}
};
...
\begin{itemize}
  ...
  \item \toolmark\ Successfully established the Nvidia Nsight Compute (NCU) environment
\end{itemize}
};
...
\begin{itemize}
  ...
  \item \toolmark\ Established basic NCU Profile Flow Optimization for large profile data
...
\begin{tabular}{@{}llll@{}}
\optmark\ Optimization/Analysis &
\confmark\ Conference/Paper &
\toolmark\ Tooling/Setup &
