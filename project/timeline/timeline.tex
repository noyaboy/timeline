...
% Title
\begin{center}
{\Large\bfseries Research Timeline of Master Thesis}\\[0.3em]
{\normalsize Hao-Chun Liang}\\[0.2em]
...
% Timeline spine (page 1 only - ends at page break)
\draw[timeline] (0, 0) -- (0, -15.5);
...
\begin{itemize}
  \item \confmark\ Created posters for \conf{TJCAS} and \conf{FastML}
...
\begin{itemize}
  ...
  \item \optmark\ Recorded an algorithm tutorial video for junior students
\end{itemize}
};
